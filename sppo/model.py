...
class Model(object):
    ...
    def __init__(self, *, policy, ob_space, ac_space, nbatch_act, nbatch_train,
                nsteps, ent_coef, vf_coef,lf_coef, max_grad_norm, init_labda=1., microbatch_size=None, threshold=1.):
        ...
        l_lambda2 = tf.reduce_mean(tf.clip_by_value(ratio, 1.0 - CLIPRANGE, 1.0 + CLIPRANGE) * l_ADV + v_l - self.safety_threshold)
        ...
        self.loss_names = ['policy_loss', 'value_loss', 'safety_value_loss','policy_entropy', 'approxkl', 'clipfrac', 'lagrangian']
    ...
    def train(self, lr, cliprange, obs, obs_,returns,l_returns, masks, actions, values,l_values,mb_l_rewards, neglogpacs,states=None):
        ...
        td_map = {
            ...
            self.safety_threshold:self.threshold
        }
