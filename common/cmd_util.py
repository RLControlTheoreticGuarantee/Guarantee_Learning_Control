...
def common_arg_parser():
    ...
    parser.add_argument('--evaluate', help='evaluate or not', default=False)
    parser.add_argument('--evaluation_paths', help='number of paths for evaluation', type=int, default=10)
