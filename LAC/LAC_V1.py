...
class LAC(object):
    def __init__(self,
        ...
        with tf.variable_scope('Actor'):
            ...
            self.a_preloss = a_preloss = tf.reduce_mean(self.alpha * tf.expand_dims(log_pis, axis=1) + min_Q_target - policy_prior_log_probs)
...
def train(variant):
    ...
    policy = LAC(a_dim,s_dim,d_dim, policy_params)
    ...
    for i in range(max_episodes):
        ...
        for j in range(max_ep_steps):
            ...
            if training_started:
                ...
                current_path['d_alpha'].append(d_alpha)
