...
COLORS = ['blue', 'brown', 'red','green', 'salmon','cyan', 'magenta','darkred',  'yellow', 'black', 'purple', 'pink',
...
def read_eval_data(alg_path, eval_list, content):
    ...
    for eval_content in eval_list:
        ...
        try:
            ...
            continue
        if 'impulse' in eval_content or 'disturbance' in eval_content or 'safety_eval' in eval_content:
...
def collect_line(eval_content, data, content_list):
    ...
    if eval_content == 'impulse'or eval_content == 'constant_impulse' or eval_content=='safety_eval':
        x_name = 'magnitude'
    ...
    if eval_content=='safety_eval':
        x_name = 'initial x position'
    measure = {}
    stds = {}
    for content in content_list:
        try:
    ...
    for content in contents:
        ...
        for exp in results.keys():
            ...
            if args['formal_plot']:
                ...
                plt.savefig('-'.join(['training', exp, content]) + '.pdf')
                plt.show()
            exp_index += 1
        content_index += 1
    if not args['formal_plot']:
...
def plot_line(results, alg_list, eval_contents, measure_list, exp, figsize = None):
    ...
    for eval_index, eval_name in enumerate(eval_contents):
        ...
        for content_index, content in enumerate(measure_list):
            ...
            if args['formal_plot']:
                plt.savefig(eval_name + '-' + content + '.pdf')
                plt.show()
...
def main(args, alg_list, measure_list, env):
    ...
    if args['data'] == 'training':
        ...
        for content in args['eval_content']:
            if 'impulse' in content or 'disturbance' in content or 'safety_eval' in content:
...
if __name__ == '__main__':
    ...
    alg_list = [
        ...
        # 'RLAC',
        'SAC',
        # 'SAC_cost-low-entropy',
        # 'LAC-infinite-horizon',
        # 'MPC',
        # 'LQR',
        ...
        # 'N=20',
        # 'infinite horizon'
        # 'RLAC-finite_horizon-10',
        # # 'LAC-energy_bounded-mag=100',
        # 'RARL-new',
        # 'RARL',
        # 'LSAC-clip-10',
        'LSAC',
        ...
        # 'RLAC-ita=1',
        # 'RLAC-pn-inturn-train',
        # 'RLAC-eb-120-5',
        # 'LAC-energy_bounded-mag=50'
               ]
    ...
    env = ['Pointcircle-v0', 'CartPolecons-v0','Antcpo-v1','Quadrotor-v1','HalfCheetahcons-v0' ][2:3]
